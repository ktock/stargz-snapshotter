...
ps auxww | grep containerd | grep -v grep > /output/org/ps.txt
...
ctr-remote run --rm --snapshotter=stargz \
  ...
  fio /fio.conf --output /output/summary.txt
ps auxww | grep containerd | grep -v grep > /output/sgz/ps.txt
...
ctr-remote run --rm --snapshotter=stargz \
  ...
  fio /fio.conf --output /output/summary.txt
ps auxww | grep containerd | grep -v grep > /output/esgz/ps.txt
